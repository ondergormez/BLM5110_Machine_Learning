...
* Şu basit şeyleri yapın fakat bunlarla yetinmeyin tabi
  * batch size ını 500 den 1500 e kadar değiştirdimm.
  * parametreyi 0.1 den 1 e kadar değiştirdim.
  * learning rate i 0.1 den 1 e kadar değiştirdim.
  * Veri setiniz büyükse hepsini kullanmadan temel hataları çözün. Sonra tüm veriseti üzeirinde çalışın ki süreç hızlansın.
...
* İlk seferde seçtiğimiz konuyu beğenmezse bir hak daha vereceğim.
