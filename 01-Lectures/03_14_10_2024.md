...
* Doğru örneklerin tam ortasından geçerek tüm veri setini temsil edebilecek şekilde olmalıdır.
...
* Mesela sıcaklık 90 Derece ölçüm yapılmış 1 tane, normal aralık 0 - 30 derece arasıysa bunu normalize ederken önemli verilerin distance farkını ignore etmiş oluyoruz.
